...
export default function Sidenav() {
  ...
  const activeText = "bg-white text-cyan-700 font-semibold";
  ...
  return (
    <div>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-cyan-700 dark:bg-gray-800">
